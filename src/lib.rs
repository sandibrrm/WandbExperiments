// src/lib.rs
/*
 * Core library for WandbExperiments
 */
...
#[derive(Debug)]
pub struct WandbExperimentsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WandbExperimentsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WandbExperiments processing");
    
    let mut processor = WandbExperimentsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WandbExperimentsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WandbExperimentsProcessor::new(false);
